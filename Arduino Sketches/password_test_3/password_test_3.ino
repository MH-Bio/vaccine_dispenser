...
//********************************************* Addresses *******************************************
byte coolingPotentiometerAddress = 0x00; // address for the potentiometer in the cooling module
...
//****************************************** Joystick Stuff *****************************************
const int SW_pin = 37; // digital pin that the joystick is plugged into
...
//*********************************************** Pins **********************************************
int potentiometerCS = 3; // chip select pin for the digital potentiometer (cooling module control)
int lockPullupResistorPin = 6; // This sets the pin that will be used as the lock's pullup resistor
int lockRelayPin = 4; // Sets the pin that will be used to communicate with the lock
//***************************************************************************************************

//**************************************** Temperature Stuff ****************************************
float currentTemperature = 0;
int setTemperature = 0;  // set temperature point
int temperaturePin = 2; // analog pin A2
int temperatureOutputPin = 22; // sets the pin which will be used to control the pletier module
//***************************************************************************************************
...
int temperature() {
  ...
  temperature = temperature + 2.0; // offset correction
