...
// Picture dimention definations
const int __Gnbmp_height = 153;                 // 320 bmp hight
const int __Gnbmp_width  = 107;                 // 240 bmp width
unsigned char __Gnbmp_image_offset  = 0;        // offset

// File related info
int __Gnfile_num = 1;                           // num of file
char __Gsbmp_files[1][FILENAME_LEN] = {"01.bmp",};
File bmpFile;
...
void bmpdraw(File f, int x, int y) {
  ...
  for (int i = 0; i < __Gnbmp_height; i++) {
    for (int j = 0; j < (__Gnbmp_height / BUFFPIXEL); j++) {
